...
# Schedule: 06:30 UTC every day (fetches previous day's data)
# Note: yfinance data is typically available by UTC 06:00-08:00
...
with DAG(
    ...
    t2_trigger_fng = TriggerDagRunOperator(
    	...
    	reset_dag_run       = True,
    	conf                = {"exec_date": "{{ data_interval_start.date() | string }}"},
	)
